...
<h4 dir="rtl">التفالـــس : <code>faillite</code></h4>
<div dir="rtl">توقف التاجر عن دفع ديونه التجارية تقصيراً أو احتيالاً.</div>

---

<h4 dir="rtl">التخريب : <code>sabotage</code></h4>
<div dir="rtl">جعل الشيء غير قابل للإستعمال حسب ما أعدّ له.</div>

---

<h4 dir="rtl">التعييب : <code>deformation</code></h4>
<div dir="rtl">جعل الشيء غير قابل للإستعمال بالكفاءة التي كان عليها.</div>

---

<h4 dir="rtl">الإتلاف : <code>dommage</code></h4>
<div dir="rtl">إنهاء صلاحية الشيء لما أعدّ له وجعله غير قابل للإصلاح.</div>

---

<h4 dir="rtl">الحدث : <code>mineur-non-emancipe</code></h4>
<div dir="rtl">من أتمّ السابعة من عمره ولم يتمّ الثامنة عشرة.</div>

---

<h4 dir="rtl">الراشد : <code>majeur</code></h4>
<div dir="rtl">هو من أتمّ الثامنة عشرة من عمره.</div>

---

<h4 dir="rtl">الإنحراف : <code>delinquence</code></h4>
<div dir="rtl">هو ارتكاب الحدث فعلاً يُعاقِب عليه القانون.</div>

---

<h4 dir="rtl">العلامة التجارية : <code>marque-commerciale</code></h4>
<div dir="rtl">كل ما يأخذ شكلاً مميّزاً من كلمات أو إمضاءات أو حروف أو أرقام أو رسوم أو رموز أو عناوين أو أختام أو تصاوير أو نقوش أو أية علامة أخرى أو أي مجموع منها، إذا كانت تستخدم أو يُراد إستخدامها في تمييز بضائع أو منتجات للدلالة على أنها تخصّ صاحب العلامة بسبب صنعها أو إختيارها أو الإتجار بها أو عرضها للبيع.</div>

---

<h4 dir="rtl">الأوراق المالية (السندات والأسهم) : <code>billet-argent</code></h4>
<div dir="rtl">السندات التي تمثّل جزء من دين في ذمّة مصدرها (سندات)، أو تمثّل جزء من رأسمال المصدر (أسهم).</div>

---

<h4 dir="rtl">السندات العامة (سندات الخزينة) : <code>bon-tresor</code></h4>
<div dir="rtl">السندات التي تصدرها الدولة لتمويل النفقات.</div>

---

<h4 dir="rtl">السندات الخاصة (سندات الشركات) : <code>bon-entreprise</code></h4>
<div dir="rtl">سندات تصدرها الأشخاص المعنوية الخاصة المخوّلة بذلك.</div>

---

<h4 dir="rtl">المطبوعات : <code>publications</code></h4>
<div dir="rtl">الكتابات والرسوم والإسطوانات وأشرطة التسجيل والصور الشمسية وغير ذلك من وسائل التعبير إذا كانت قابلة للتداول.</div>

---

<h4 dir="rtl">الملكية الفكرية : <code>propriete-intellectuelle</code></h4>
<div dir="rtl">مجموع الحقوق المادية والمعنوية لشخص على مؤلفاته الفكرية.</div>

---

<h4 dir="rtl">حقوق المؤلف : <code>droits-auteurs</code></h4>
<div dir="rtl">هو الحقّ الذي يمنحه القانون لصاحب أثر فكري على إنتاجه.</div>

---

<h4 dir="rtl">النيابة العامة : <code>parquet-general</code></h4>
<div dir="rtl">الهيئة الرسمية المختصّة بالتحقيق في الجرائم وإقامة الدعوى العامة ومباشرتها ضد مرتكب الجريمة ومتابعة تنفيذ العقوبات وتدابير الوقاية التي تصدر عن المحكمة.</div>

---

<h4 dir="rtl">الشرطة : <code>police</code></h4>
<div dir="rtl">هيئة رسمية تتبع النيابة العامة وتعمل تحت إمرتها وإشرافها للتحري عن وقوع الجرائم وجمع أدلتها والبحث عن مرتكبيها وذلك في سياق عملها في المحافظة على الأمن الداخلي.</div>

---

<h4 dir="rtl">الشرطة القضائية : <code>Police-Judiciaire</code></h4>
<div dir="rtl">هيئة رسمية تتبع النيابة العامة وتقوم بتنفيذ الأوامر القضائية الصادرة إليها.</div>

---

<h4 dir="rtl">ضابط الشرطة القضائية : <code>officier-police-judiciaire</code></h4>
<div dir="rtl">موظف عمومي تابع للشرطة القضائية مختصّ بتلقي الإخبارات والشكاوي التي ترد إليه في شأن الجرائم وكذلك القيام بالتحريّات والمعاينات والتدابير القانونية اللازمة.</div>

---

<h4 dir="rtl">أمر الحبس الإحتياطي : <code>ordre-mise-en-garde</code></h4>
<div dir="rtl">مذكرة تصدر عن النيابة العامة أو عن قاضي التحقيق أو المحكمة الجزائية ضد المتهم بجناية أو جنحة بإيداعه المكان المخصّص لذلك تحت نظام الحبس الإحتياطي.</div>

---

<h4 dir="rtl">الحكم المستعجل : <code>jugement-refere</code></h4>
<div dir="rtl">الحكم الوقتي الذي يصدره القاضي المختصّ بعد دعوة الأطراف في المسائل المستعجلة ودون مساس بأصل الحقّ.</div>

---

<h4 dir="rtl">الشبكة المعلوماتية : <code>reseaux-informatiques</code></h4>
<div dir="rtl">إرتباط بين أكثر من نظام معلوماتي للحصول على المعلومات وتبادلها.</div>

---

<h4 dir="rtl">البرنامج المعلوماتي : <code>programme-informatique</code></h4>
<div dir="rtl">مجموعة من التعليمات والأوامر، قابلة للتنفيذ باستخدام الحاسب الآلي ومعدّة لإنجاز مهمة ما.</div>
